cask "nosleep" do
  ...
  url "https://github.com/MikeCVermeer/NoSleep/releases/download/v#{version}/NoSleep-#{version}.zip?download=1",
      verified: "github.com/MikeCVermeer/NoSleep/"
  name "NoSleep"
  desc "Native macOS menu-bar utility that keeps your Mac awake"
  homepage "https://github.com/MikeCVermeer/NoSleep"

  livecheck do
    skip "Release is managed manually."
  end
